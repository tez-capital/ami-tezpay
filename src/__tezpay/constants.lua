return {
    ...
    sources = {
        ["linux-x86_x64"] = "https://github.com/tez-capital/tezpay/releases/download/0.5.0-alpha/tezpay-linux-amd64",
        ["linux-arm64"] = "https://github.com/tez-capital/tezpay/releases/download/0.5.0-alpha/tezpay-linux-arm64"
    }
}
